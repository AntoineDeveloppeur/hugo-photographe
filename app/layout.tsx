import './globals.scss'
import { lora, baskervville, merriweather, taviraj } from './font'
import { Metadata } from 'next'
import Providers from '@/components/Providers'

// Récupérer l'URL de base à partir d'une variable d'environnement ou utiliser l'URL de base par défaut
const baseUrl =
  process.env.NEXT_PUBLIC_BASE_URL || 'https://photographe-hugo-randez.fr'

export const metadata: Metadata = {
  title: 'Photographe du monde Hugo Randez',
  description:
    'Découvrez des destinations exotiques et vivez des aventures uniques avec les photos de voyage de Hugo Randez. Une expérience visuelle inoubliable.',
  icons: {
    icon: '/favicon.ico',
