  ...
  return (
    <section className={styles.supprimer}>
      <div className={styles.supprimer__largeScreen}>
        ...
        <motion.div className={styles.supprimer__largeScreen__cards}>
          <AnimatePresence mode="wait">
            {currentPage === 1 && (
              <div
                key="cardLandscape"
                className={
                  styles.supprimer__largeScreen__cards__cardLandscapteWrapper
                }
              >
                {isMobile ? (
                  <CardPortrait
        ...
        {isExpandedView ? (
          ...
          projectsCount > 4 && (
            <div
              ...
              className={styles.supprimer__largeScreen__moreProjectsWrapper}
            >
