...
export default function BenefitsSection() {
  return (
    <section className="bg-[#000000] py-16 px-4 text-white min-h-screen">
      <p className="text-lg font-bold block justify-center text-center text-[#A0A0A0] mb-3">
        —
      </p>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-full max-w-md bg-[#8EB6FF] rounded-2xl p-8 text-center">
            ...
            <h3 className="text-2xl font-bold mb-4 text-[#060606]">
              {benefits[0].title}
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {benefits.slice(1).map((benefit, index) => (
            <div
              key={index}
              className="bg-transparent border border-[#598EFF] rounded-2xl p-8 text-center"
            >
              <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full bg-white">
                {benefit.icon}
              </div>
